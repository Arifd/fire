...
// Check if Script Processor Node is available.
export function detectScriptProcessorNode() {
  let context = new OfflineAudioContext(1, 1, 44100);
  return Boolean(context.createScriptProcessor());
}

////////////////////////////////////////////////////////////

// Check if AudioWorklet is available.
export function detectAudioWorklet() {
  let context = new OfflineAudioContext(1, 1, 44100);
  return Boolean(
...
export function createScaledImageFromSource(src, scaleFactor, callback = null)
{
  let img = new Image();
  img.src = src;
...
export const TWOPI = 6.28318530717958647693;

////////////////////////////////////////////////////////////
// smootherstep: smoothly interpolate between two numbers.
